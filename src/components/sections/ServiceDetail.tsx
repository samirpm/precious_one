    ...
    <main className="min-h-screen overflow-x-clip bg-ivory">
      ...
      <section className="service-hero relative flex min-h-screen flex-col overflow-hidden bg-charcoal">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1440px] flex-1 flex-col justify-end px-6 pb-16 pt-28 sm:px-8 md:px-10 md:pb-20 lg:px-16">
          ...
          >
            <Link href="/" className="transition-colors duration-300 hover:text-white/80" data-cursor="link">
              Home
            </Link>
            <span>/</span>
            <Link href="/#services" className="transition-colors duration-300 hover:text-white/80" data-cursor="link">
              Services
            </Link>
            <span>/</span>
